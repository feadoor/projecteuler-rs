...
//! as 1, 2, 4, 5, 7, and 8, are all less than nine and relatively prime to nine, ϕ(9) = 6.
//!
...
//!
//! Find the value of n, 1 < n < 10<sup>7</sup>, for which ϕ(n) is a permutation of n and the ratio
//! n / ϕ(n) produces a minimum.
//!
//! # Solution detail
//!
