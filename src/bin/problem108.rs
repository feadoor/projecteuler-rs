...
//!
//! We are therefore searching for the smallest `n` for which `d(n²)` is at least 2001 (in general,
//! greater than `2 * target` where `target` is the number of solutions we want to be in excess of).
//!
